...
**Hippocrat AI - это первый в России AI ассистент для студентов медиков, в экосистеме которого находится уже более 2000 студентов**
...
Ты станешь не просто сотрудником, а **главным креативным лицом Hippocrat AI**. В мире, где каждая компания борется за внимание, мы ищем человека, который станет настоящим **лицом революции в медицинском образовании**.
...
• **Прозрачная мотивация:** Фиксированные денежные бонусы за виральные видео + премии. Вы сможете зарабатывать деньги, совмещая это с учёбой.
• **Карьерный трамплин:** Возможность возглавить целые направления в компании
• **Техническая поддержка:** Доступ к современному оборудованию и софту. Мы обеспечим Вас всеми необходимыми инструментами для комфортного роста.
• **Команда мечты:** Окружение амбициозных студентов, горящих своим делом. Новые знакомства и идейные коллеги.

**В чем будет заключаться твоя роль?**

• **Создание виральных вертикальных видео** (Reels, Клипы, Shorts)
• **Активное участие в жизни комьюнити** студентов-медиков
• **Генерация креативных идей** для развития проекта

**Возможности для роста:**

• Стать **главным маркетологом** растущей медтех компании
• Развить **личный бренд** в сфере медицины 
• Войти в **топ-менеджмент** развивающейся MedTech компании`
  },
  {
    id: 'python-developer',
...
Мы не просто создаем очередной образовательный проект. Мы строим интеллектуальную экосистему для врачей и студентов, и наш AI-ассистент для студентов-медиков — это только первый шаг.

**Почему эта возможность уникальна?**

Мы ищем **тебя** — человека, которому нравится медицина и программирование. Ты станешь **ключевым техническим звеном** нашей команды и будешь принимать архитектурные решения продукта, которым пользуются тысячи студентов.
...
• **Уникальный опыт:** Работа с LLM, AI и медицинскими данными. Уникальный опыт в реальных проектах
• **Полная свобода:** Мы не стоим над душой, ты сам определяешь как решать задачи

**Направления работы:**

• **Backend разработка:** Оптимизация Python бэкенда
• **API интеграции:** Работа с новыми API и моделями
• **Архитектура:** Проектирование архитектуры для новых сервисов
• **Продуктовые решения:** Участие в определении вектора развития и поддержании рабочего продукта

**Технический стек:**
  
Мы не просим 10 лет опыта и диплом, важно только желание и некоторые базовые навыки
• **Понимание веб-разработки:** знаком с HTML, CSS, JS (Typescript будет плюсом)
• **Базовые концепции python:** умеешь читать код, писать свой код, понимать ошибки
• **Умение решать проблемы:** умеешь гуглить, читать документацию и использовать chatgpt эффективно
• **Базовое понимание git и консоли:** нужно для эффективной разработки
• **желание узнать что-то новое:** в процессе разработки что-то новое появляется каждый день

**Что мы предлагаем:**

• **Заработная плата:** Попроектная оплата. В среднем 20.000-35.000 рублей за выполненные проекты. Неплохо для студента!
• **Уникальный опыт:** Работа в самой горячей сфере — AI + медицина + новые технологии
      ...
      <Container size="xl" padding="lg">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16 lg:mb-20">
          ...
          <div className="prose prose-lg max-w-none font-golos-text text-text-secondary leading-relaxed space-y-6 text-base">
            <p>
              Превращаем медицинские вызовы в технологичные решения! Команде Hippocrat AI требуются новые сотрудники
            </p>
            
            <p>
              Мы верим в то, что создавать качественные продукты для медицины, могут только люди, связанные с медициной! 
            ...
            <p>
              ...
              Мы видим в технологичной медицине будущее, и готовы возглавить 
              то направление. Стань частью этой истории.
            </p>
          </div>
        </div>
